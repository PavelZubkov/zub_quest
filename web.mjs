...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $zub_quest_task.prototype, "title", null);
    __decorate([
        $mol_mem
    ], $zub_quest_task.prototype, "done", null);
    __decorate([
        $mol_mem
    ], $zub_quest_task.prototype, "owner", null);
    __decorate([
        $mol_mem
    ], $zub_quest_task.prototype, "executor", null);
    $.$zub_quest_task = $zub_quest_task;
})($ || ($ = {}));
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $zub_quest_space.prototype, "title", null);
    __decorate([
        $mol_mem
    ], $zub_quest_space.prototype, "owner", null);
    __decorate([
        $mol_mem
    ], $zub_quest_space.prototype, "tasks_node", null);
    __decorate([
        $mol_mem
    ], $zub_quest_space.prototype, "task_list", null);
    __decorate([
        $mol_action
    ], $zub_quest_space.prototype, "task_add", null);
    __decorate([
        $mol_action
    ], $zub_quest_space.prototype, "task_drop", null);
    $.$zub_quest_space = $zub_quest_space;
})($ || ($ = {}));
...
(function ($) {
    class $zub_quest_person extends $hyoo_crowd_struct {
        ...
        space_fund() {
            return this.world().Fund($zub_quest_space);
        }
        spaces_list() {
    ...
    __decorate([
        $mol_mem
    ], $zub_quest_person.prototype, "name", null);
    __decorate([
        $mol_mem
    ], $zub_quest_person.prototype, "spaces_node", null);
    __decorate([
        $mol_mem
    ], $zub_quest_person.prototype, "space_fund", null);
    __decorate([
        $mol_mem
    ], $zub_quest_person.prototype, "spaces_list", null);
    __decorate([
        $mol_action
    ], $zub_quest_person.prototype, "space_add", null);
    __decorate([
        $mol_action
    ], $zub_quest_person.prototype, "space_drop", null);
    $.$zub_quest_person = $zub_quest_person;
})($ || ($ = {}));
...
;
	($.$zub_quest_person_spaces) = class $zub_quest_person_spaces extends ($.$mol_page) {
		space_add(){
			return (this.person().space_add());
		}
		space_drop(id){
			return (this.person().space_drop(id));
		}
		Space_add_icon(){
		...
		Space_add(){
			...
			(obj.click) = () => ((this.space_add()));
			(obj.sub) = () => ([(this.Space_add_icon())]);
			return obj;
		}
		space_id(id){
			return "";
		...
		space_title(id){
			return (this.$.$mol_locale.text("$zub_quest_person_spaces_space_title"));
		}
		Space_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"space": (this.space_id(id))});
			(obj.title) = () => ((this.space_title(id)));
			return obj;
		}
		Space_drop_icon(id){
		...
		Space_drop(id){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = () => ((this.space_drop(id)));
			(obj.sub) = () => ([(this.Space_drop_icon(id))]);
			return obj;
		}
		Space(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Space_link(id)), (this.Space_drop(id))]);
			return obj;
		}
		space_list(){
			return [(this.Space("0"))];
		...
		Space_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.space_list()));
			return obj;
		}
		person(){
			const obj = new this.$.$zub_quest_person();
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$zub_quest_person_spaces_title"));
		}
		tools(){
			return [(this.Space_add())];
		}
		body(){
			return [(this.Space_list())];
		}
	};
	($mol_mem(($.$zub_quest_person_spaces.prototype), "Space_add_icon"));
	($mol_mem(($.$zub_quest_person_spaces.prototype), "Space_add"));
	($mol_mem_key(($.$zub_quest_person_spaces.prototype), "Space_link"));
	($mol_mem_key(($.$zub_quest_person_spaces.prototype), "Space_drop_icon"));
	($mol_mem_key(($.$zub_quest_person_spaces.prototype), "Space_drop"));
	($mol_mem_key(($.$zub_quest_person_spaces.prototype), "Space"));
	($mol_mem(($.$zub_quest_person_spaces.prototype), "Space_list"));
	($mol_mem(($.$zub_quest_person_spaces.prototype), "person"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $zub_quest_person_spaces.prototype, "space_list", null);
        $$.$zub_quest_person_spaces = $zub_quest_person_spaces;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        const { rem } = $mol_style_unit;
        $mol_style_define($zub_quest_person_spaces, {
            Body: {
                padding: $mol_gap.block,
            },
            Space_link: {
...
;
	($.$zub_quest_space_tasks) = class $zub_quest_space_tasks extends ($.$mol_page) {
		space_title(next){
			return (this.space().title(next));
		}
		task_add(){
			return (this.space().task_add());
		}
		task_drop(id){
			return (this.space().task_drop(id));
		}
		Task_add_icon(){
			const obj = new this.$.$mol_icon_plus();
			return obj;
		...
		Task_add(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = () => ((this.task_add()));
			(obj.sub) = () => ([(this.Task_add_icon())]);
			return obj;
		}
		task_title(id, next){
			if(next !== undefined) return next;
		...
		Task_done(id){
			...
			(obj.title) = () => ("");
			(obj.checked) = (next) => ((this.task_done(id, next)));
			return obj;
		}
		Task_drop_icon(id){
			const obj = new this.$.$mol_icon_cross();
		...
		Task_drop(id){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = () => ((this.task_drop(id)));
			(obj.sub) = () => ([(this.Task_drop_icon(id))]);
			return obj;
		}
		Task(id){
			const obj = new this.$.$mol_view();
		...
		space(){
			const obj = new this.$.$zub_quest_space();
			return obj;
		}
		Title(){
			const obj = new this.$.$mol_string_button();
			(obj.value) = (next) => ((this.space_title(next)));
			return obj;
		}
		tools(){
	...
	($mol_mem(($.$zub_quest_space_tasks.prototype), "Task_add_icon"));
	($mol_mem(($.$zub_quest_space_tasks.prototype), "Task_add"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "task_title"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "Task_title"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "task_done"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "Task_done"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "Task_drop_icon"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "Task_drop"));
	($mol_mem_key(($.$zub_quest_space_tasks.prototype), "Task"));
	($mol_mem(($.$zub_quest_space_tasks.prototype), "Task_list"));
	($mol_mem(($.$zub_quest_space_tasks.prototype), "filter"));
	($mol_mem(($.$zub_quest_space_tasks.prototype), "Filter"));
	($mol_mem(($.$zub_quest_space_tasks.prototype), "space"));
	($mol_mem(($.$zub_quest_space_tasks.prototype), "Title"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$zub_quest_space_tasks = $zub_quest_space_tasks;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        const { rem } = $mol_style_unit;
        $mol_style_define($zub_quest_space_tasks, {
            Body: {
                padding: $mol_gap.block,
            },
            flex: {
...
;
	($.$zub_quest_app) = class $zub_quest_app extends ($.$mol_book2) {
		Online(){
		...
		Spaces(){
			const obj = new this.$.$zub_quest_person_spaces();
			(obj.person) = () => ((this.user()));
			(obj.foot) = () => ([(this.Online())]);
			return obj;
		}
		space(){
			const obj = new this.$.$zub_quest_space();
		...
		Tasks(){
			const obj = new this.$.$zub_quest_space_tasks();
		...
		pages(){
			return [(this.Spaces()), (this.Tasks())];
		}
	};
	($mol_mem(($.$zub_quest_app.prototype), "Online"));
	($mol_mem(($.$zub_quest_app.prototype), "Spaces"));
	($mol_mem(($.$zub_quest_app.prototype), "space"));
	($mol_mem(($.$zub_quest_app.prototype), "Tasks"));
	($mol_mem(($.$zub_quest_app.prototype), "yard"));
	($mol_mem(($.$zub_quest_app.prototype), "user"));
    ...
    (function ($$) {
        class $zub_quest_app extends $.$zub_quest_app {
            ...
            space() {
                ...
                return fund.Item(this.space_opened());
            }
            home() {
        ...
        __decorate([
            $mol_mem
        ], $zub_quest_app.prototype, "home", null);
        __decorate([
            $mol_mem
        ], $zub_quest_app.prototype, "user", null);
        $$.$zub_quest_app = $zub_quest_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($zub_quest_app, {});
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
