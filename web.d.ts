...
declare namespace $ {
	...
	type $mol_view__title__42PJ7OGO = $mol_type_enforce<
		string
		,
...
declare namespace $ {
	...
	type $mol_pop_bubble__align__E76WJNZ8 = $mol_type_enforce<
		ReturnType< $mol_pop['align'] >
		,
		ReturnType< $mol_pop_bubble['align'] >
	>
	type $mol_pop_bubble__content__F19C2OCE = $mol_type_enforce<
		ReturnType< $mol_pop['bubble_content'] >
		,
		ReturnType< $mol_pop_bubble['content'] >
	>
	type $mol_pop_bubble__height_max__6OV2AVRV = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_speck__value__76Y5NVSI = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__sub__UXYCF1VL = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_check__minimal_width__A2EN8LMD = $mol_type_enforce<
		number
		,
		ReturnType< $mol_check['minimal_width'] >
	>
	type $mol_check__minimal_height__1L8YZVEF = $mol_type_enforce<
		number
		,
		ReturnType< $mol_check['minimal_height'] >
	>
	type $mol_check__enabled__T9VPT6C0 = $mol_type_enforce<
		ReturnType< $mol_pick['trigger_enabled'] >
		,
		ReturnType< $mol_check['enabled'] >
	>
	type $mol_check__checked__REAJ40YW = $mol_type_enforce<
		ReturnType< $mol_pick['showed'] >
		,
		ReturnType< $mol_check['checked'] >
	>
	type $mol_check__clicks__W7P9K9CZ = $mol_type_enforce<
		ReturnType< $mol_pick['clicks'] >
		,
		ReturnType< $mol_check['clicks'] >
	>
	type $mol_check__sub__GU52H50I = $mol_type_enforce<
		ReturnType< $mol_pick['trigger_content'] >
		,
		ReturnType< $mol_check['sub'] >
	>
	type $mol_check__hint__K0N3SZKW = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_paragraph__sub__AHZ9FKRA = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_paragraph['sub'] >
	>
	type $mol_paragraph__sub__7ADJKWST = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_paragraph['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_view__style__HYYDH6TZ = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__U1JIFV8C = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_hotkey__mod_ctrl__ACRKLKPX = $mol_type_enforce<
		ReturnType< $mol_string['submit_with_ctrl'] >
		,
		ReturnType< $mol_hotkey['mod_ctrl'] >
	>
	type $mol_hotkey__key__FX4OKPWQ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__ISMCL0G5 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_hotkey__key__S2AKNSKF = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_hotkey['key'] >
	>
	type $mol_nav__keys_y__6Q8NQKRM = $mol_type_enforce<
		ReturnType< $mol_search['nav_components'] >
		,
		ReturnType< $mol_nav['keys_y'] >
	>
	type $mol_nav__current_y__WC9087SJ = $mol_type_enforce<
		ReturnType< $mol_search['nav_focused'] >
		,
		ReturnType< $mol_nav['current_y'] >
	>
	type $mol_string__value__9RJTDSOJ = $mol_type_enforce<
		ReturnType< $mol_search['query'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint__S41KTAWX = $mol_type_enforce<
		ReturnType< $mol_search['hint'] >
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__submit__GRP3FLAK = $mol_type_enforce<
		ReturnType< $mol_search['submit'] >
		,
		ReturnType< $mol_string['submit'] >
	>
	type $mol_string__enabled__2R86DCFS = $mol_type_enforce<
		ReturnType< $mol_search['enabled'] >
		,
		ReturnType< $mol_string['enabled'] >
	>
	type $mol_string__keyboard__MS4HCQ2M = $mol_type_enforce<
		ReturnType< $mol_search['keyboard'] >
		,
		ReturnType< $mol_string['keyboard'] >
	>
	type $mol_string__enter__LIHOBU2Q = $mol_type_enforce<
		ReturnType< $mol_search['enter'] >
		,
		ReturnType< $mol_string['enter'] >
	>
	type $mol_button_minor__hint__U5L6MERH = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click__K2N9NV0I = $mol_type_enforce<
		ReturnType< $mol_search['clear'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__BASTU7AA = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_list__rows__WXV493TM = $mol_type_enforce<
		ReturnType< $mol_search['menu_items'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_dimmer__haystack__KLH5O2N0 = $mol_type_enforce<
		ReturnType< $mol_search['suggest_label'] >
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__needle__7YS0FXEQ = $mol_type_enforce<
		ReturnType< $mol_search['query'] >
		,
		ReturnType< $mol_dimmer['needle'] >
	>
	type $mol_search_plugins__7ZHVR84E = $mol_type_enforce<
		ReturnType< $mol_pop['plugins'] >[number]
		,
		$mol_plugin
	>
	type $mol_view__sub__XQOPQ8RF = $mol_type_enforce<
		ReturnType< $mol_search['anchor_content'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__click__YVGNKJZI = $mol_type_enforce<
		ReturnType< $mol_search['suggest_select'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__65X1MH0I = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_dimmer__haystack__WOGF7Z9T = $mol_type_enforce<
		ReturnType< $mol_select['option_label'] >
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__needle__VYQWH3TK = $mol_type_enforce<
		ReturnType< $mol_select['filter_pattern'] >
		,
		ReturnType< $mol_dimmer['needle'] >
	>
	type $mol_nav__keys_y__L9TDQJOX = $mol_type_enforce<
		ReturnType< $mol_select['nav_components'] >
		,
		ReturnType< $mol_nav['keys_y'] >
	>
	type $mol_nav__current_y__FHO36IUJ = $mol_type_enforce<
		ReturnType< $mol_select['option_focused'] >
		,
		ReturnType< $mol_nav['current_y'] >
	>
	type $mol_nav__cycle__ITCFZQNF = $mol_type_enforce<
		ReturnType< $mol_select['nav_cycle'] >
		,
		ReturnType< $mol_nav['cycle'] >
	>
	type $mol_list__rows__8J4DHVE9 = $mol_type_enforce<
		ReturnType< $mol_select['menu_content'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_scroll__sub__DR9A3NSA = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $mol_button_minor__event_click__84SKV3G4 = $mol_type_enforce<
		ReturnType< $mol_select['event_select'] >
		,
		ReturnType< $mol_button_minor['event_click'] >
	>
	type $mol_button_minor__sub__OF0CGQX1 = $mol_type_enforce<
		ReturnType< $mol_select['option_content'] >
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub__O27RF69H = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_search__query__IDPWK2GC = $mol_type_enforce<
		ReturnType< $mol_select['filter_pattern'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_search__hint__TH3DMHWA = $mol_type_enforce<
		ReturnType< $mol_select['filter_hint'] >
		,
		ReturnType< $mol_search['hint'] >
	>
	type $mol_search__submit__W2PV1013 = $mol_type_enforce<
		ReturnType< $mol_select['submit'] >
		,
		ReturnType< $mol_search['submit'] >
	>
	type $mol_search__enabled__V67HY0U0 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $hyoo_sync_online_master_cursor__EXKR7XWW = $mol_type_enforce<
		Parameters< $hyoo_sync_online['master_cursor'] >[0]
		,
		Parameters< ReturnType< $hyoo_sync_online['yard'] >['master_cursor'] >[0]
	>
	type $mol_avatar__id__DEJ2RD6H = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['master_id'] >
		,
		ReturnType< $mol_avatar['id'] >
	>
	type $mol_avatar__id__2WMWZ5PK = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['master_link'] >
		,
		ReturnType< $mol_avatar['id'] >
	>
	type $mol_link__uri__O2X4RZWD = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['master_link'] >
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__sub__TZIG1C8L = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['link_content'] >
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_link__hint__Y5ZAT2PC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__dom_name__KIS52MM8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__BE8ZLDZO = $mol_type_enforce<
		ReturnType< $mol_page['title_content'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub__8ZVN0SUK = $mol_type_enforce<
		ReturnType< $mol_page['tools'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__minimal_height__VEKOJ4YH = $mol_type_enforce<
		number
		,
		ReturnType< $mol_view['minimal_height'] >
	>
	type $mol_view__dom_name__X94YASTA = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__43L866U7 = $mol_type_enforce<
		ReturnType< $mol_page['head'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_page_body_scroll_top__TPB29HSB = $mol_type_enforce<
		Parameters< $mol_page['body_scroll_top'] >[0]
		,
		Parameters< ReturnType< $mol_page['Body'] >['scroll_top'] >[0]
	>
	type $mol_view__sub__6VE3F21Q = $mol_type_enforce<
		ReturnType< $mol_page['body'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_scroll__sub__5L4M5C2U = $mol_type_enforce<
		ReturnType< $mol_page['body_content'] >
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $mol_view__dom_name__OZX6KKH5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__0D1YEC3D = $mol_type_enforce<
...
declare namespace $ {
	...
	type $zub_quest_person_spaces_space_drop__GLD2A79T = $mol_type_enforce<
		Parameters< $zub_quest_person_spaces['space_drop'] >[0]
		,
		Parameters< ReturnType< $zub_quest_person_spaces['person'] >['space_drop'] >[0]
	>
	type $mol_button_major__click__67PIVGIQ = $mol_type_enforce<
		ReturnType< $zub_quest_person_spaces['space_add'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub__1SXOJCTX = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_link__arg__92Y1KX4Z = $mol_type_enforce<
		({ 
	...
	>
	type $mol_link__title__4VSCN1VO = $mol_type_enforce<
		ReturnType< $zub_quest_person_spaces['space_title'] >
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_button_minor__click__TWUOT3TK = $mol_type_enforce<
		ReturnType< $zub_quest_person_spaces['space_drop'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__GB7GFWT7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub__2VSOV30A = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows__CQWQNDHT = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_check__checked__W0CNY9HV = $mol_type_enforce<
		ReturnType< $mol_check_list['option_checked'] >
		,
		ReturnType< $mol_check['checked'] >
	>
	type $mol_check__label__6101W236 = $mol_type_enforce<
		ReturnType< $mol_check_list['option_label'] >
		,
		ReturnType< $mol_check['label'] >
	>
	type $mol_check__enabled__H3DYGUFP = $mol_type_enforce<
		ReturnType< $mol_check_list['option_enabled'] >
		,
		ReturnType< $mol_check['enabled'] >
	>
	type $mol_check__hint__I97H81VD = $mol_type_enforce<
		ReturnType< $mol_check_list['option_hint'] >
		,
		ReturnType< $mol_check['hint'] >
	>
	type $mol_check__minimal_height__TUD69KLU = $mol_type_enforce<
		number
		,
		ReturnType< $mol_check['minimal_height'] >
	>
...
declare namespace $ {
	...
	type $zub_quest_space_tasks_space_title__JH1YE8SI = $mol_type_enforce<
		Parameters< $zub_quest_space_tasks['space_title'] >[0]
		,
		Parameters< ReturnType< $zub_quest_space_tasks['space'] >['title'] >[0]
	>
	type $zub_quest_space_tasks_task_drop__VJFARJ0Z = $mol_type_enforce<
		Parameters< $zub_quest_space_tasks['task_drop'] >[0]
		,
		Parameters< ReturnType< $zub_quest_space_tasks['space'] >['task_drop'] >[0]
	>
	type $mol_button_major__click__84MVMAJY = $mol_type_enforce<
		ReturnType< $zub_quest_space_tasks['task_add'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub__TNWP78CG = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_string_button__hint__XT5R6FAQ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string_button['hint'] >
	>
	type $mol_string_button__value__K1UPHJPO = $mol_type_enforce<
		ReturnType< $zub_quest_space_tasks['task_title'] >
		,
		ReturnType< $mol_string_button['value'] >
	>
	type $mol_check_box__title__LXDV1N0O = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked__HFZ3T7PF = $mol_type_enforce<
		ReturnType< $zub_quest_space_tasks['task_done'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_button_minor__click__OSG8ZN2V = $mol_type_enforce<
		ReturnType< $zub_quest_space_tasks['task_drop'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__XDZGEG5I = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub__FGT04XAV = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows__CKZQIT6S = $mol_type_enforce<
		ReturnType< $zub_quest_space_tasks['task_list'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_switch__value__TAQVQCOX = $mol_type_enforce<
		ReturnType< $zub_quest_space_tasks['filter'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options__ZI4I5VUZ = $mol_type_enforce<
		({ 
			'': string,
			'false': string,
			'true': string,
	...
	>
	type $mol_string_button__value__QQ9NW0JR = $mol_type_enforce<
...
declare namespace $ {
	...
	type $hyoo_sync_online__yard__4QDGIHFB = $mol_type_enforce<
		ReturnType< $zub_quest_app['yard'] >
		,
		ReturnType< $hyoo_sync_online['yard'] >
	>
	type $zub_quest_person_spaces__person__CW2RS33A = $mol_type_enforce<
		ReturnType< $zub_quest_app['user'] >
		,
		ReturnType< $zub_quest_person_spaces['person'] >
	>
	type $zub_quest_person_spaces__foot__M7XPV997 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $zub_quest_person_spaces['foot'] >
	>
	type $zub_quest_space_tasks__space__BD0ZEJ09 = $mol_type_enforce<
